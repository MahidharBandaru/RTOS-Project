  ...
  render() {
    ...
    return (this.state.loading) ? (<Stack isInline spacing={4}>
      ...
      <Box bg="black" w="100%" p={4} color="white">
        ...
        <Browser>
          {this.state.docsData.map((doc) => (<FileLink link={`/editor/${this.props.projectId}/${doc.url}/`} color={this.props.docId === doc.url ? "black" : "teal"}>{doc.title.length !== 0 ? doc.title : doc.url}</FileLink>))}
        </Browser>
